...
export async function POST(request:Request) {
  ...
  const key = await sha256(JSON.stringify({version:11,problem:input.problem,language:input.language,code}));
